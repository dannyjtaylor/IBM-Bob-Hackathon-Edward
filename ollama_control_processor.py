"""
Ollama AI Control Processor
Processes screenshots with local Ollama AI and executes computer control actions
"""
...
from ollama_client import OllamaVisionClient, get_ollama_client
...
class OllamaControlProcessor:
    """
    Processes screenshots with Ollama AI and executes control actions.
    """
    ...
    def __init__(
        ...
        """
        Initialize Ollama control processor.
        
        Args:
            ollama_client: Ollama vision client
        ...
        logger.info("Ollama Control Processor initialized")
    ...
    async def initialize(self):
        ...
        try:
            ...
            if not self.ollama_client.check_model_available():
                logger.warning(f"⚠️ Model {self.ollama_client.model} not found!")
                logger.warning(f"Run: ollama pull {self.ollama_client.model}")
    ...
    async def process_screenshot(self, screenshot_data: Dict[str, Any]):
        ...
        try:
            ...
            logger.info("Analyzing screenshot with Ollama AI...")
            action = await asyncio.to_thread(
                self.ollama_client.analyze_screenshot,
                screenshot_base64,
...
class OllamaAutonomousLoop:
    """
    Autonomous control loop using local Ollama AI.
    """
    ...
    def __init__(
        ...
        """
        Initialize Ollama autonomous control loop.
        ...
        self.processor = OllamaControlProcessor(
        ...
        logger.info("Ollama Autonomous Control Loop initialized")
    ...
    async def start(self):
        ...
        logger.info("Starting Ollama autonomous control loop...")
        ...
        logger.info("Ollama autonomous control loop started")
    ...
    async def stop(self):
        ...
        logger.info("Stopping Ollama autonomous control loop...")
        ...
        logger.info("Ollama autonomous control loop stopped")
